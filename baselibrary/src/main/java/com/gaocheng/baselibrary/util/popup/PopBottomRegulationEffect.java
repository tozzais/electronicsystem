...
public class PopBottomRegulationEffect implements OnWheelChangedListener {


	private static PopBottomRegulationEffect cityUtils;

	public static PopBottomRegulationEffect getInstance() {
		if (cityUtils == null) {
			synchronized (PopBottomRegulationEffect.class) {
				if (cityUtils == null) {
					cityUtils = new PopBottomRegulationEffect();
				}
			}
		}
		return cityUtils;
	...
	public void showSelectDialog(final Context context , List<RiverRegulationLoadData.RenovationEffectBean> mList, final onSelectCityFinishListener listener) {
...
//		cityDialog.onWindowAttributesChanged(wl);
	...
	private void setUpData(List<RiverRegulationLoadData.RenovationEffectBean> mList) {
		List<String> list = new ArrayList<>();
		for (RiverRegulationLoadData.RenovationEffectBean bean:mList){
			list.add(bean.Name);
		}
	...
	public interface onSelectCityFinishListener {
		public void onFinish(RiverRegulationLoadData.RenovationEffectBean s);
	}
