...
public class PopBottomRegulationCase implements OnWheelChangedListener {


	private static PopBottomRegulationCase cityUtils;

	public static PopBottomRegulationCase getInstance() {
		if (cityUtils == null) {
			synchronized (PopBottomRegulationCase.class) {
				if (cityUtils == null) {
					cityUtils = new PopBottomRegulationCase();
				}
			}
		}
		return cityUtils;
	...
	public void showSelectDialog(final Context context , List<RiverRegulationLoadData.RenovationSituationListBean> mList, final onSelectCityFinishListener listener) {
...
//		cityDialog.onWindowAttributesChanged(wl);
	...
	private void setUpData(List<RiverRegulationLoadData.RenovationSituationListBean> mList) {
		List<String> list = new ArrayList<>();
		for (RiverRegulationLoadData.RenovationSituationListBean bean:mList){
			list.add(bean.Name);
		}
	...
	public interface onSelectCityFinishListener {
		public void onFinish(RiverRegulationLoadData.RenovationSituationListBean s);
	}
