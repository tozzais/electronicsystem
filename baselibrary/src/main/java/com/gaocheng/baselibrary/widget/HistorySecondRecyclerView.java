...
public class HistorySecondRecyclerView extends RecyclerView {
    ...
    public HistorySecondRecyclerView(Context context) {
        this(context, null);
    }

    public HistorySecondRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HistorySecondRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
