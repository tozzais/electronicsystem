 ...
 * 修改备注：
 */
public class StaticticalRemediationPlanAdapter extends BaseQuickAdapter<RiverHistoryBean, BaseViewHolder> {


    public StaticticalRemediationPlanAdapter() {
        super(R.layout.item_statictical_remediation_plan, null);
    }
    ...
    protected void convert(final BaseViewHolder helper, final RiverHistoryBean item) {
        ...
        helper.setText(R.id.tv_total,item.PlanCount);
