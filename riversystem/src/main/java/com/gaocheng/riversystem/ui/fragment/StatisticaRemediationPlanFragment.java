...
import com.gaocheng.riversystem.adapter.recycleview.StaticticalRemediationPlanAdapter;
...
public class StatisticaRemediationPlanFragment extends BaseListFragment<RiverHistoryBean> {


//    protected StaticticalRemediationPlanAdapter mAdapter;
    ...
    private void getData() {
        ...
        new RxHttp<BaseListResult<RiverHistoryBean>>().send(ApiManager.getService().getRemediationPlanList(),
    ...
    private void initAdapter() {
        ...
        mAdapter = new StaticticalRemediationPlanAdapter();
