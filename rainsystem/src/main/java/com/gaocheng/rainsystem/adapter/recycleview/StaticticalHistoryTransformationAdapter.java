 ...
 * 修改备注：
 */
public class StaticticalHistoryTransformationAdapter extends BaseQuickAdapter<RainHistoryBean, BaseViewHolder> {


    public StaticticalHistoryTransformationAdapter() {
        super(R.layout.item_statictical_history_transformation, null);
    }

    @Override
    protected void convert(final BaseViewHolder helper, final RainHistoryBean item) {

        RecyclerView barchart = helper.getView(R.id.barchart);
        LinearLayout ll_root = helper.getView(R.id.ll_root);

        helper.setText(R.id.tv_town_name,item.TownName);
        helper.setText(R.id.tv_community_name,item.Total);
    ...
    private void onclick(BaseViewHolder helper, RainHistoryBean item, View ll_more ){
    ...
    //4 10
        private void getData(RecyclerView recyclerView, final RainHistoryBean item) {
