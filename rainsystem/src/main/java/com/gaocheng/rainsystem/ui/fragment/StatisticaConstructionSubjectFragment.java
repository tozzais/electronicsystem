...
import com.gaocheng.rainsystem.adapter.recycleview.StaticticalConstructionSubjectAdapter;
...
public class StatisticaConstructionSubjectFragment extends BaseListFragment<ConstructSubjectBean> {


//    protected StaticticalConstructionSubjectAdapter mAdapter;
    ...
    private void initAdapter() {
        ...
        mAdapter = new StaticticalConstructionSubjectAdapter();
...
//        });
    ...
    private void getData() {
        ...
        new RxHttp<BaseListResult<ConstructSubjectBean>>().send(ApiManager.getService().getConstructSubjectList(),
                new Response<BaseListResult<ConstructSubjectBean>>(mActivity, false) {
                    @Override
                    public void onNext(BaseListResult<ConstructSubjectBean> beanBaseListResult) {
    ...
    private void setData(List<ConstructSubjectBean> data) {
